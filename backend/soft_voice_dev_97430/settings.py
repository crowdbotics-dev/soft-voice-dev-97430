"""
Django settings for soft_voice_dev_97430 project.
...
ROOT_URLCONF = 'soft_voice_dev_97430.urls'
...
WSGI_APPLICATION = 'soft_voice_dev_97430.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "soft_voice_dev_97430 API",
    "DESCRIPTION": "API documentation for soft_voice_dev_97430 App",
    "VERSION": "v1",
}
